...
Data-surface capabilities are projected from typed secret-store and database
events when an adapter supplies them; current complete-observation coverage is
non-vacuous for MCP TypeScript execution.
